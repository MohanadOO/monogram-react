...
export default function Navbar() {
  return (
    <nav className='fixed w-full z-10'>
      <ul className='flex items-center bg-color14 m-4 px-2 py-2 text-color8 tracking-[2px] font-extralight gap-5'>
        <li>
          <Link to='/' className='hover:text-color10 hover:transition my-1'>
            <svg
            ...
            >
              ...
              <path d='M150,36V0H0V114H150ZM144,6V36H78V6ZM6,6H72V72H6ZM72,108H6V78H72Zm72,0H78V78h0V42h66Z' />
              <rect x='35.5' y='17' width='6' height='44' />
              <rect x='53' y='17' width='6' height='44' />
              <rect x='18' y='17' width='6' height='44' />
              <path d='M111.5,50a25,25,0,1,0,25,25A25,25,0,0,0,111.5,50Zm0,44a19,19,0,1,1,19-19A19,19,0,0,1,111.5,94Z' />
              <polygon points='206.809 62.675 197.497 42.37 191.584 42.37 191.586 72.048 197.523 72.048 197.523 55.206 205.264 72.048 208.374 72.048 216.112 55.206 216.112 72.048 222.042 72.048 222.042 42.37 216.116 42.37 206.809 62.675' />
              ...
              <polygon points='289.285 61.212 276.742 42.59 276.593 42.37 270.888 42.37 270.888 72.048 277.114 72.048 277.114 53.166 289.807 72.048 295.512 72.048 295.512 42.37 289.285 42.37 289.285 61.212' />
              ...
              <path d='M430.287,41.958h-5.74L412.621,71.636h6.435l2.59-6.606h11.5l2.633,6.606h6.391L430.412,42.271Zm1.033,17.766h-7.845L427.4,49.45Z' />
              <polygon points='476.574 41.958 467.268 62.263 457.955 41.958 452.043 41.958 452.031 71.636 457.969 71.636 457.969 54.794 465.709 71.636 468.82 71.636 476.56 54.794 476.56 71.636 482.501 71.636 482.501 41.958 476.574 41.958' />
        ...
        <div className='hidden ml-auto gap-8 md:flex md:text-xs'>
          <li className='cursor-pointer hover:text-color10 hover:transition'>
          ...
          <li className='font-bold cursor-pointer hover:text-color10 hover:transition'>
            <Link to='/'>SHOP</Link>
          </li>
        </div>
